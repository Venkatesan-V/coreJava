...
public class Dummy {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.get("https://www.youtube.com/@naveenautomationlabs/playlists");
		...
		List<WebElement> head = driver.findElements(By.xpath("//h3[@class='style-scope ytd-grid-playlist-renderer']"));
